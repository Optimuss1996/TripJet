export const tourFilters = [
  {
    ...
    options: [
      { label: "از ۰ تا ۲۰ میلیون تومان", value: "0to20" },
      { label: "از ۲۰ تا ۳۵ میلیون تومان", value: "20to35" },
      { label: "از ۳۵ تا ۵۰ میلیون تومان", value: "35to50" },
      { label: "از ۵۰ میلیون تومان به بالا", value: "gt50" },
    ],
  },
  {
    id: "tourType",
